...
plugins=(git sudo z zsh-autosuggestions zsh-syntax-highlighting zsh-history-substring-search fzf-tab-source fzf-tab)
...
alias pc='sudo pacman -Sc' # remove unused cache, pacman
alias yc='yay -Sc --aur'   # remove unused cache, yay
